    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button className="bg-[#F6B40E] hover:bg-[#dda10d] font-bold px-16">¡Colaboremos juntos!</Button>
            </DialogTrigger>
                ...
                <div className="flex flex-row justify-between space-x-8">
                    ...
                    <div className="flex flex-col w-1/2 justify-between">
                        <div className='text-white justify-center text-md mt-[100px]'>
                            <DialogTitle className="text-lg font-semibold text-center justify-center">
                                ¡Colaboremos juntos!
                            </DialogTitle>
