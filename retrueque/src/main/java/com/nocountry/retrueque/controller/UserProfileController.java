...
public class UserProfileController {
    ...
    public ResponseEntity<ApiResponse<UserProfileRes>> createUserProfile(
        ...
        UserProfileReq userProfileReq = buildUserProfileReq(profileImage, dniFrontImage, dniBackImage, phone, departamentoId);
    ...
    public ResponseEntity<ApiResponse<UserProfileRes>> updateUserProfile(
        ...
        UserProfileReq updateReq = buildUserProfileReq(profileImage, dniFrontImage, dniBackImage, phone, departamentoId);
    ...
    private UserProfileReq buildUserProfileReq(MultipartFile profileImage, MultipartFile dniFrontImage, MultipartFile dniBackImage, String phone, Long departamentoId) {
        ...
        return new UserProfileReq(profileImageUrl, dniFrontImageUrl, dniBackImageUrl, phone, departamentoId);
    }
}
